...
nimbleInits = list(
             list(beta=rep(0, times=p), tausq=1.0, yFit=rep(0, times=N), w=rep(0, times=N), tausq_sp=1.0),
             list(beta=rep(-100, times=p), tausq=10.0, yFit=rep(0, times=N), w=rep(0, times=N), tausq_sp=1.0),
             list(beta=rep(100, times=p), tausq=0.10, yFit=rep(0, times=N), w=rep(0, times=N), tausq_sp=1.0)
            ) 
