...
nimbleInits <- list(beta=rep(0, times=p), deltasq=1.0, sigmasqSp=1.0, phi=3/300,  yFit=rep(0, times=N), w=rep(0, times=N))
```
...
Combine all chains in samps into a single matrix.
```{r, combine_chains}
